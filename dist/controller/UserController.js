...
var UserController = /** @class */ (function () {
    ...
    UserController.getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    userRepository = (0, typeorm_1.getRepository)(Users_1.Users);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
    ...
    UserController.new = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, username, password, role, user, validationOpt, errors, userRepository, e_3;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, class_validator_1.validate)(user, validationOpt)];
                case 1:
                    errors = _c.sent();
                    if (errors.length > 0) {
    ...
    UserController.edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, id, _b, username, role, userRepository, e_4, validationOpt, errors, e_5;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                    id = req.params.id;
