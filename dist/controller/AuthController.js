...
var AuthController = /** @class */ (function () {
    ...
    AuthController.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, username, password, userRepository, user, e_1, token;
    ...
    AuthController.changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, _b, oldPassword, newPassword, userRepository, user, e_2, validationOps, errors;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, class_validator_1.validate)(user, validationOps)];
                case 5:
                    errors = _c.sent();
                    if (errors.length > 0) {
